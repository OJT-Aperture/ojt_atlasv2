...
const mainMenuItems: NavItem[] = [
  {
    label: "Main menu",
    icon: (
      <div className="relative w-6 h-6 aspect-[1] shrink-0" aria-hidden="true">
        <img
...
const settingsItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <div className="relative w-5 h-5 aspect-[1] shrink-0" aria-hidden="true">
        <img
...
export const SidebarBrandSection = (): JSX.Element => {
    ...
    >
      <div className="flex flex-col w-[216px] h-[479px] items-start gap-10 absolute top-[22px] left-[30px]">
        ...
        <div className="flex flex-col items-start gap-20 relative self-stretch w-full flex-[0_0_auto] mb-[-197.00px]">
          ...
          >
            <h2 className="relative flex items-center self-stretch h-4 mt-[-1.00px] [font-family:'Poppins',Helvetica] font-bold text-black text-xl tracking-[-0.44px] leading-[30px] whitespace-nowrap">
              Main menu
            </h2>
            <div className="flex flex-col w-[167px] items-start gap-4 relative flex-[0_0_auto]">
              {mainMenuItems.map((item) => {
                ...
                const labelClassName =
                  "relative flex items-center w-[137px] h-4 mr-[-4.00px] [font-family:'Poppins',Helvetica] font-normal text-black text-xl tracking-[-0.44px] leading-[30px] whitespace-nowrap";
            ...
            <div className="flex flex-col w-44 items-start gap-4 relative flex-[0_0_auto]">
              {settingsItems.map((item) => {
                ...
                const itemClassName =
                  "flex items-center gap-2.5 relative self-stretch w-full flex-[0_0_auto]";
                const labelClassName =
                  "relative flex items-center w-[137px] h-4 [font-family:'Poppins',Helvetica] font-normal text-black text-xl tracking-[-0.44px] leading-[30px] whitespace-nowrap";
