...
const settingsMenuItems: MenuItem[] = [
  {
    label: "Instellingen",
    isActive: true,
    icon: <img className="relative w-5 h-5" alt="" src="/img/vector-191.svg" />,
  },
  {
    label: "Help",
        ...
        <div className="flex flex-col items-start gap-20 relative self-stretch w-full flex-[0_0_auto] mb-[-197.00px]">
          <section className="flex flex-col items-start gap-5 relative self-stretch w-full flex-[0_0_auto]">
            ...
            <nav
              ...
              className="flex flex-col w-[167px] items-start gap-4 relative flex-[0_0_auto]"
            >
          ...
          <section className="flex flex-col items-start gap-5 relative self-stretch w-full flex-[0_0_auto]">
            ...
            <nav
              ...
              className="flex flex-col w-44 items-start gap-4 relative flex-[0_0_auto]"
            >
